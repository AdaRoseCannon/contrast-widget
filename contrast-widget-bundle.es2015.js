...
var chartist = __commonjs(function (module, exports, global) {
...
function getContrastForEl (el) {
	...
	const bColor = new Color$1(backgroundColor);
	const fColor = new Color$1(color);
...
function main() {
	...
	css();
	const line = new chartist$1.Line(chartWrapper, {
		...
		width: '300px',
		height: '200px',
		lineSmooth: chartist$1.Interpolation.simple({
			divisor: 2
		})
	});
